                ...
                <Container className="">
                    ...
                    <div>
                        <Breadcrumb className="bred">
                            ...
                            <Breadcrumb.Item href=""><span className="bred-items">Customer Records</span></Breadcrumb.Item>
                                        ...
                                        <tr  key={product.id}>
                                            ...
                                            <td className="t-data-6">
                                                <ButtonGroup aria-label="Basic example">
                                                    <Button className="btn-edit"variant="success"><Edit className="" height="15px"/></Button>
...
//                     }
//                 })
//                 this.productArr.id.push(elements.id);
//             })
