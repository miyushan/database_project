                            ...
                            {customers.map((customer) =>{
                                return (
                                    <tr key={customer.id}>
                                        ...
                                        <td className="t-data-c t-data-c4">{customer.Salary}</td>
                                        ...
                                        <td className="t-data-c">
                                            <ButtonGroup aria-label="Basic example">
                                                <Button href="/db/delivery-person/edit" className="btn-edit"variant="success"><Edit className="edit-p" height="15px"/></Button>
                                                <Button href="/db/delivery-person" className="btn-delete" onClick={() => deleteCustomer(customer.id)} variant="success"><Delete className="delete-p" height="15px"/></Button>
                                            </ButtonGroup>
                                        </td>
                                    </tr>
                                );
