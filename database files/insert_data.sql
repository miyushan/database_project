...
INSERT INTO `Orders` (`id`, `total_weight`, `total_cost`, `customer_id`, `Employee_id`, `Posting_Date`) VALUES
(1, 25.2, 464.50, 1, 4, '2021-09-01 08:25:29'),
(2, 12.6, 324.50, 2, 5, '2021-09-01 09:14:57'),
(3, 9.26, 534.50, 3, 6, '2021-09-01 10:32:15');

INSERT INTO `Product` (`id`, `name`, `total_weight`, `price_per_kg`, `Posting_Date`) VALUES
...
INSERT INTO `Order_Item` ( `weight`, `cost`, `Product_id`, `Order_id`, `Posting_Date`) VALUES
