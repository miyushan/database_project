<?php
    ...
    if(isset($postdata) && !empty($postdata)){
        ...
        $sql = "UPDATE delivery_person SET `First_Name`='$First_Name', `Last_Name`='$Last_Name', `Gender`='$Gender', `Salary`='$Salary', `Contact_Number`='$Contact_Number', `Branch_Name`='$Branch_Name', `Password`='$Password', `Address`='$Address' WHERE id=$id";
